...
<head>
	...
	<title><?php echo getBareGalleryTitle(); ?> | Albums Index</title>
...
<div id="main">
	...
	<div id="gallerytitle">
		<h2><span><?php printHomeLink('', ' | '); ?><a href="<?php echo htmlspecialchars(getGalleryIndexURL());?>" title="<?php echo gettext('Home'); ?>"><?php echo getGalleryTitle();?></a> | Album Index</h2>
